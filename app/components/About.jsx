            ...
            className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
                ...
                <motion.div
                    ...
                    <p className='mb-10 max-w-2xl font-Ovo'>
                        I am a 4th-year Computer Engineering student at <span className="text-blac-600 font-semibold">ENSA</span>, passionate about 
                        <span className="text-blac-600 font-semibold"> full-stack development</span>.  
                        With hands-on experience in multiple projects, I specialize in building 
                        <span className="text-blac-600 font-semibold"> dynamic and efficient web applications</span>.  
